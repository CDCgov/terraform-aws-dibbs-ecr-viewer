...
| [aws_wafv2_web_acl_association.external_waf](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/wafv2_web_acl_association) | resource |
...
| <a name="input_block_ip_set"></a> [block\_ip\_set](#input\_block\_ip\_set) | List of IP to block | `list(string)` | `[]` | no |
...
| <a name="input_waf_enabled"></a> [waf\_enabled](#input\_waf\_enabled) | Flag to enable AWS WAF for ALB - NIST ELB.16 Compliance | `bool` | `true` | no |
| <a name="input_waf_rules"></a> [waf\_rules](#input\_waf\_rules) | n/a | `list(any)` | <pre>[<br>  {<br>    "allow": [],<br>    "block": [],<br>    "captcha": [],<br>    "challenge": [],<br>    "count": [<br>      "NoUserAgent_HEADER",<br>      "UserAgent_BadBots_HEADER",<br>      "SizeRestrictions_BODY",<br>      "SizeRestrictions_QUERYSTRING",<br>      "SizeRestrictions_Cookie_HEADER",<br>      "SizeRestrictions_URIPATH",<br>      "EC2MetaDataSSRF_BODY",<br>      "EC2MetaDataSSRF_COOKIE",<br>      "EC2MetaDataSSRF_URIPATH",<br>      "EC2MetaDataSSRF_QUERYARGUMENTS",<br>      "GenericLFI_QUERYARGUMENTS",<br>      "GenericLFI_URIPATH",<br>      "GenericLFI_BODY",<br>      "RestrictedExtensions_URIPATH",<br>      "RestrictedExtensions_QUERYARGUMENTS",<br>      "GenericRFI_QUERYARGUMENTS",<br>      "GenericRFI_BODY",<br>      "GenericRFI_URIPATH",<br>      "CrossSiteScripting_BODY",<br>      "CrossSiteScripting_COOKIE",<br>      "CrossSiteScripting_QUERYARGUMENTS",<br>      "CrossSiteScripting_URIPATH"<br>    ],<br>    "name": "AWSManagedRulesCommonRuleSet",<br>    "priority": 1,<br>    "vendor_name": "AWS"<br>  },<br>  {<br>    "allow": [],<br>    "block": [],<br>    "captcha": [],<br>    "challenge": [],<br>    "count": [<br>      "LFI_URIPATH",<br>      "LFI_QUERYSTRING",<br>      "LFI_HEADER"<br>    ],<br>    "name": "AWSManagedRulesLinuxRuleSet",<br>    "priority": 2,<br>    "vendor_name": "AWS"<br>  },<br>  {<br>    "allow": [],<br>    "block": [],<br>    "captcha": [],<br>    "challenge": [],<br>    "count": [<br>      "UNIXShellCommandsVariables_QUERYARGUMENTS",<br>      "UNIXShellCommandsVariables_BODY"<br>    ],<br>    "name": "AWSManagedRulesUnixRuleSet",<br>    "priority": 3,<br>    "vendor_name": "AWS"<br>  },<br>  {<br>    "allow": [],<br>    "block": [],<br>    "captcha": [],<br>    "challenge": [],<br>    "count": [<br>      "SQLi_QUERYARGUMENTS",<br>      "SQLiExtendedPatterns_QUERYARGUMENTS",<br>      "SQLi_BODY",<br>      "SQLiExtendedPatterns_BODY",<br>      "SQLi_COOKIE"<br>    ],<br>    "name": "AWSManagedRulesSQLiRuleSet",<br>    "priority": 4,<br>    "vendor_name": "AWS"<br>  },<br>  {<br>    "allow": [],<br>    "block": [],<br>    "captcha": [],<br>    "challenge": [],<br>    "count": [<br>      "JavaDeserializationRCE_HEADER",<br>      "JavaDeserializationRCE_BODY",<br>      "JavaDeserializationRCE_URIPATH",<br>      "JavaDeserializationRCE_QUERYSTRING",<br>      "Host_localhost_HEADER",<br>      "PROPFIND_METHOD",<br>      "ExploitablePaths_URIPATH",<br>      "Log4JRCE_HEADER",<br>      "Log4JRCE_QUERYSTRING",<br>      "Log4JRCE_BODY",<br>      "Log4JRCE_URIPATH"<br>    ],<br>    "name": "AWSManagedRulesKnownBadInputsRuleSet",<br>    "priority": 5,<br>    "vendor_name": "AWS"<br>  },<br>  {<br>    "allow": [],<br>    "block": [],<br>    "captcha": [],<br>    "challenge": [],<br>    "count": [<br>      "SignalAutomatedBrowser",<br>      "CategoryHttpLibrary",<br>      "SignalNonBrowserUserAgent",<br>      "CategoryAdvertising",<br>      "CategoryArchiver",<br>      "CategoryContentFetcher",<br>      "CategoryEmailClient",<br>      "CategoryLinkChecker",<br>      "CategoryMiscellaneous",<br>      "CategoryMonitoring",<br>      "CategoryScrapingFramework",<br>      "CategorySearchEngine",<br>      "CategorySecurity",<br>      "CategorySeo",<br>      "CategorySocialMedia",<br>      "CategoryAI",<br>      "SignalKnownBotDataCenter"<br>    ],<br>    "name": "AWSManagedRulesBotControlRuleSet",<br>    "priority": 6,<br>    "vendor_name": "AWS"<br>  }<br>]</pre> | no |
| <a name="input_waf_web_acl_id"></a> [waf\_web\_acl\_id](#input\_waf\_web\_acl\_id) | Existing WAF Web ACL ID to associate with ALB. If empty, a new ACL will be created. | `string` | `""` | no |
| <a name="input_waf_web_acl_name"></a> [waf\_web\_acl\_name](#input\_waf\_web\_acl\_name) | Name of the WAF Web ACL to create if not using existing one | `string` | `""` | no |
