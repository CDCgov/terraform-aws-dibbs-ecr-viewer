...
| <a name="input_ecr_viewer_object_mode"></a> [ecr\_viewer\_object\_mode](#input\_ecr\_viewer\_object\_mode) | Mode to set the S3 ecr viewer objects to | `string` | `"GOVERNANCE"` | no |
| <a name="input_ecr_viewer_object_retention_days"></a> [ecr\_viewer\_object\_retention\_days](#input\_ecr\_viewer\_object\_retention\_days) | Number of days to retain S3 ecr viewer objects in compliance mode | `number` | `365` | no |
...
| <a name="input_logging_object_mode"></a> [logging\_object\_mode](#input\_logging\_object\_mode) | Mode to set the S3 logging objects to | `string` | `"GOVERNANCE"` | no |
| <a name="input_logging_object_retention_days"></a> [logging\_object\_retention\_days](#input\_logging\_object\_retention\_days) | Number of days to retain S3 logging objects in compliance mode | `number` | `365` | no |
...
| <a name="output_waf_ip_set_arn"></a> [waf\_ip\_set\_arn](#output\_waf\_ip\_set\_arn) | The ARN of the WAF IP Set for blocking IPs |
